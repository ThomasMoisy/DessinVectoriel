...
public class CheminOld extends Element implements IElement {
	...
	public CheminOld(boolean visibilite, Couleur couleur, int epaisseur, List<Vecteur> vecteurs) {
	...
	public static CheminOld creer(boolean visibilite, Couleur couleur, int epaisseur, List<Vecteur> vecteurs){
		return new CheminOld(visibilite, couleur, epaisseur, vecteurs);
	}
